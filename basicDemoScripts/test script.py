...
clean = np.load('/home/emmanuel/Desktop/EBSD_thesis_codes/clean.npy'); clean = clean[0]
misori = ebsd.orient.misorientation_map(clean[:-1, :-1,], clean[1:, 1:])
# Flatten the 2D array to 1D
flattened_data = misori.flatten()

plt.figure(figsize=(6,6))
# Plot histogram
plt.hist(flattened_data, bins=20, range=(50, 200), color='blue', alpha=0.7)
...
plt.savefig('./clean_hist_all.png')
plt.show()
